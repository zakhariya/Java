...
public class Constants {
    ...
    public static final String PROGRAM_PATH = System.getProperty("user.dir");  //directory where java was run from, where you started
    //the JVM (if not on console, it will be path to program)
    ...
    public static final String APPLICATION_NAME = "Трансфер данных";
