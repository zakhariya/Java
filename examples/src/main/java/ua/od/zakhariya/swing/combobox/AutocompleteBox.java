package ua.od.zakhariya.swing.combobox;
...
public class AutocompleteBox extends PlainDocument {
    ...
    public AutocompleteBox(JComboBox comboBox) {
        this.comboBox = comboBox;
        comboBox.setEditable(true);
        comboBox.addItem("One");
        comboBox.addItem("Two");
        comboBox.addItem("Three");
        comboBox.addItem("Ooo");
        ...
        editor.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                ...
                if (hidePopupOnFocusLoss) AutocompleteBox.this.comboBox.setPopupVisible(false);
            }
        });
        ...
        editor.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(java.awt.event.KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                    ...
                    AutocompleteBox.this.comboBox.setSelectedIndex(0);
                    AutocompleteBox.this.editor.setText(AutocompleteBox.this.comboBox.getSelectedItem().toString());
                    highlightCompletedText(0);
                }
            }
        });
    ...
    public static void main(String...strings) {
        ...
        AutocompleteBox comboBoxer =
                new AutocompleteBox(new JComboBox<>());
        JDialog dialog = new JDialog();

        dialog.add(comboBoxer.comboBox);
